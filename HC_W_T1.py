...
df=pd.read_csv('HC_W_T1.csv')
labels=list(df.columns.values)
print(labels)
P_=df.iloc[0:40, 2:41].values
#P_=df.iloc[0:39, 2:38].values
...
net=prn.CreateNN([n-1,5,2,1], dIn=[0], dIntern=[], dOut=[])

net=prn.train_LM(X, Y, net, verbose=True)
